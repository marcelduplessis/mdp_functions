...
if __name__ == '__main__':
    ...
    A=coare36vn_zrf_et(u, zu, tair, zt, rh, zq, P, tsea, sw_dn, lw_dn, lat, lon, jd, zi, rain, sss, cp, sigH, zrf_u, zrf_t, zrf_q)
    
    from datetime import datetime
    date = datetime.now()
    fnameA = os.path.join(path,f'ooi_oc4920_coare_output_{date.strftime("%Y%m%d%H")}_withnowavesinput_nocool_nowarmlayer.txt')
